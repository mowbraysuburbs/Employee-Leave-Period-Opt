...
export function LeavePlannerTab({ leaveDays, startDate, endDate, filterSet, smartFilter, holidayFilter, legend, nested = false, onHoverPeriod, selectedKeys, onToggleSelect }) {
